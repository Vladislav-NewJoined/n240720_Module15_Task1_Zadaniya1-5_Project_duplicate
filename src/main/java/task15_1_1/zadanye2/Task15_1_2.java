...
public class Task15_1_2 {
    public static void main(String[] args) {
        ...
        file и что добавлять в gitignore, — оставьте эти файлы пустыми или посмотрите инструкцию в разделе Read the guide.
        В README file содержится краткое описание проекта на данный момент этот файл не важен, поэтому менять его
        описание не нужно. Нужно изменить  файл gitignore чтобы он не учитывал служебные папки операционной системы:
        ...
        Необходимо скопировать  данные и перенести  их в файл gitignore на GitHub.
                После редактирования gitignore сделайте коммит — записывая  в историю проекта факт того, что было  установлено
        ограничение для файлов вашей OC
